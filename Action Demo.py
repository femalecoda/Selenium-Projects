...
#when ever you are dealing with action , you have to use perform
#action.double_click(driver.find_element(By.))
#action.context_click() stand for right click
#action.drag_and_drop()
#action.move_to_element() use when testing for Hovering
